...
class Attention(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # todo: x is the h_it output from the encoder RNN (each intermediate timestep output)
        # todo: a is the entire attention matrix for each a_it vector
        # todo: so simple multiplication should be (_, seq length, features)
        # todo: we want ~each timestep's~ weighted input of h_it and a_it?:
        # todo: due to keras' layer-by-layer approach...
        # todo: https://nlp.stanford.edu/pubs/emnlp15_attn.pdf
        # todo: the sum below is for averaging into sentence vector for classification tasks
